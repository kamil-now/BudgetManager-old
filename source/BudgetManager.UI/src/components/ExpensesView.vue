<template>
  <div class="expenses-view">
    <ListView header="Expenses" v-model="expenses" :copy="copyExpense" :createNew="createExpenseObject"
      :save="createNewExpense" :update="updateExpense" :remove="deleteExpense"
      ...
      <template #editor="{ data }">
        <ExpenseInput :expense="data" @changed="onExpenseChanged(data, $event)" />
      </template>
    </ListView>
  </div>
</template>
