<template>
  <div class="fundTransfers-view">
    <ListView header="Fund Transfers" v-model="fundTransfers" :createNew="createFundTransferObject"
      :save="createNewFundTransfer" :update="updateFundTransfer" :remove="deleteFundTransfer"
      ...
      <template #editor="{ data }">
        <FundTransferInput :fundTransfer="data" @changed="onFundTransferChanged(data, $event)" />
      </template>
    </ListView>
  </div>
</template>
