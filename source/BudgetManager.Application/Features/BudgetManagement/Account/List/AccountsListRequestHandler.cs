...
public class AccountsListRequestHandler : BudgetRequestHandler<BudgetRequest<AccountDto>, IEnumerable<AccountDto>>
{
  public AccountsListRequestHandler(IUserBudgetRepository repo, IMapper map)
   : base(repo, map)
  {
  }
