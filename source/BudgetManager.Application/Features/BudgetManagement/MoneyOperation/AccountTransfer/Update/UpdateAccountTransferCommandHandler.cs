...
public class UpdateAccountTransferCommandHandler(IUserBudgetRepository repo, IMapper map)
  : UpdateMoneyOperationCommandHandler<UpdateAccountTransferCommand, AccountTransfer, AccountTransferDto>(repo, map)
{
